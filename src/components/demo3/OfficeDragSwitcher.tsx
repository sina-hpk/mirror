...
export default function OfficeDragSwitcher() {
  ...
  return (
    <div className="k-drag-switcher">
      <div
        ref={frameRef}
        className={`k-drag-frame ${dragging ? 'is-dragging' : ''}`}
      ...
      >
        <Image
          ...
          className="k-drag-img"
        />
        <div className="k-drag-frost" style={{ clipPath: `inset(0 0 0 ${100 - frostPct}%)` }} aria-hidden="true">
          <Image
        ...
        {/* خط و دستگیره مرز */}
        <div className="k-drag-handle" style={{ right: `${frostPct}%` }} aria-hidden="true">
          <span className="k-drag-grip"><MoveHorizontal size={16} /></span>
        </div>
      </div>
      <p className="k-drag-caption">
